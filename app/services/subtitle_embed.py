...
def hard_burn_subtitles(
    ...
    logger.info(f"EMBED [{task_id[:8]}] Hard burn: {subtitle_path.name} -> {output_path.name} (font={style.font_name}, size={style.font_size})")
    t0 = time.time()
    ...
    if task_id:
        log_task_event(task_id, "subtitle_embed", mode="hard", elapsed_sec=round(elapsed, 2),
                       font=style.font_name, size=style.font_size, position=style.position)
    return output_path
...
STYLE_PRESETS = {
    ...
    "youtube_white": SubtitleStyle(
        font_name="Arial", font_size=24, font_color="&HFFFFFF",
        background_color="&H000000", background_opacity=0.75,
        outline_width=0, shadow_offset=0,
    ),
    "youtube_yellow": SubtitleStyle(
        font_name="Arial", font_size=24, font_color="&H00FFFF",
        background_color="&H000000", background_opacity=0.75,
        outline_width=0, shadow_offset=0,
    ),
    "cinema": SubtitleStyle(
        font_name="Arial", font_size=28, font_color="&HFFFFFF",
        outline_color="&H000000", outline_width=3, shadow_offset=2,
        background_opacity=0,
    ),
    "large_bold": SubtitleStyle(
        font_name="Arial", font_size=36, font_color="&HFFFFFF",
        bold=True, outline_width=3, background_opacity=0,
    ),
    "top_position": SubtitleStyle(
        font_name="Arial", font_size=24, font_color="&HFFFFFF",
        position="top", margin_v=20, background_opacity=0.5,
    ),
}
