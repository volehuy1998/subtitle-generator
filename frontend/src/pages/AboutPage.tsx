...
const C = {
  ...
  primary: '#863bff', primaryLight: '#f3eeff', primaryMid: '#ddd6fe',
  ...
  return (
    <StaticPageLayout>
      ...
      <div style={{
        ...
        <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse 50% 80% at 90% 50%, rgba(134,59,255,0.22) 0%, transparent 70%)', pointerEvents: 'none' }} />
        <div style={{ width: '48px', height: '48px', background: 'rgba(134,59,255,0.25)', border: '1px solid rgba(134,59,255,0.35)', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: '2px' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          border: `1px solid ${C.primaryMid}`, borderRadius: '14px', padding: '22px 24px',
          display: 'flex', gap: '16px', alignItems: 'flex-start',
        }}>
          <div style={{ width: '42px', height: '42px', background: C.primary, borderRadius: '11px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
          ...
          <div>
            <div style={{ fontSize: '0.92rem', fontWeight: 700, color: C.primary, marginBottom: '5px', letterSpacing: '-0.2px' }}>AI-Powered Processing</div>
            <div style={{ fontSize: '0.77rem', color: '#5b21b6', lineHeight: 1.6 }}>Every subtitle is generated by a state-of-the-art AI model (OpenAI Whisper) running entirely on your infrastructure — no cloud, no third-party APIs.</div>
          </div>
        </div>
        <div style={{
          background: 'linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%)',
          border: `1px solid ${C.successBorder}`, borderRadius: '14px', padding: '22px 24px',
          display: 'flex', gap: '16px', alignItems: 'flex-start',
        }}>
          <div style={{ width: '42px', height: '42px', background: C.success, borderRadius: '11px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
          ...
          <div>
            <div style={{ fontSize: '0.92rem', fontWeight: 700, color: '#065f46', marginBottom: '5px', letterSpacing: '-0.2px' }}>Completely Free</div>
            <div style={{ fontSize: '0.77rem', color: '#064e3b', lineHeight: 1.6 }}>SubForge is MIT-licensed and free forever — no plans, no subscriptions, no usage caps. Self-host it on any machine and keep 100% of the value.</div>
          </div>
        </div>
      </div>
      ...
      <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: '16px', padding: '36px', textAlign: 'center', boxShadow: '0 1px 3px rgba(0,0,0,0.07)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '10px', flexWrap: 'wrap' }}>
          <a href="/" style={{ display: 'inline-flex', alignItems: 'center', gap: '7px', padding: '9px 20px', borderRadius: '10px', fontSize: '0.82rem', fontWeight: 600, textDecoration: 'none', background: C.primary, color: '#fff', boxShadow: '0 2px 8px rgba(134,59,255,0.3)' }}>
